...
* NVDA no longer crashes when the add-on store temporary download directory cannot be deleted during initialization, for example when a cloud backup tool has the directory locked. (#19202)
