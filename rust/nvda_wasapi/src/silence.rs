...
use crate::player::{DeviceControlHandle, WasapiPlayerInner};
use crate::BUFFER_MS;
...
impl SilencePlayer {
    ...
    pub fn new(
        ...
        let control_handle = player.control_handle();
    ...
    pub fn terminate(&mut self) {
        ...
        // Interrupt any ongoing feed using the lock-free DeviceControlHandle.
